    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <ul class="dropdown-menu" style="background-color: black">
          <li><a href="<c:url value="Keyboards"/>">KeyBoards</a></li>  
         <li><a href="<c:url value="Guitars"/>">Guitars</a></li>
          <li><a href="<c:url value="WindInstruments"/>">Wind Instruments</a></li>
          <li><a href="<c:url value="Drums"/>">Drums</a></li>
          <li><a href="#">Pianos</a></li>
          <li><a href="<c:url value="Violins"/>">Violins</a></li>
          <li><a href="<c:url value="IndianInstruments"/>">Indian Instruments</a></li>
        </ul>
        </li>
